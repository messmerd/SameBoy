...
GB_ADDIN_API void GB_init(GB_gameboy_t *gb, GB_model_t model);
GB_ADDIN_API bool GB_is_inited(GB_gameboy_t *gb);
GB_ADDIN_API bool GB_is_cgb(GB_gameboy_t *gb);
GB_ADDIN_API bool GB_is_sgb(GB_gameboy_t *gb); // Returns true if the model is SGB or SGB2
GB_ADDIN_API bool GB_is_hle_sgb(GB_gameboy_t *gb); // Returns true if the model is SGB or SGB2 and the SFC/SNES side is HLE'd
GB_ADDIN_API GB_model_t GB_get_model(GB_gameboy_t *gb);
GB_ADDIN_API void GB_free(GB_gameboy_t *gb);
GB_ADDIN_API void GB_reset(GB_gameboy_t *gb);
GB_ADDIN_API void GB_switch_model_and_reset(GB_gameboy_t *gb, GB_model_t model);

/* Returns the time passed, in 8MHz ticks. */
GB_ADDIN_API uint8_t GB_run(GB_gameboy_t *gb);
/* Returns the time passed since the last frame, in nanoseconds */
GB_ADDIN_API uint64_t GB_run_frame(GB_gameboy_t *gb);
...
GB_ADDIN_API void *GB_get_direct_access(GB_gameboy_t *gb, GB_direct_access_t access, size_t *size, uint16_t *bank);

GB_ADDIN_API void *GB_get_user_data(GB_gameboy_t *gb);
GB_ADDIN_API void GB_set_user_data(GB_gameboy_t *gb, void *data);


GB_ADDIN_API int GB_load_boot_rom(GB_gameboy_t *gb, const char *path);
GB_ADDIN_API void GB_load_boot_rom_from_buffer(GB_gameboy_t *gb, const unsigned char *buffer, size_t size);
GB_ADDIN_API int GB_load_rom(GB_gameboy_t *gb, const char *path);
GB_ADDIN_API void GB_load_rom_from_buffer(GB_gameboy_t *gb, const uint8_t *buffer, size_t size);
GB_ADDIN_API int GB_load_isx(GB_gameboy_t *gb, const char *path);
    
GB_ADDIN_API int GB_save_battery_size(GB_gameboy_t *gb);
GB_ADDIN_API int GB_save_battery_to_buffer(GB_gameboy_t *gb, uint8_t *buffer, size_t size);
GB_ADDIN_API int GB_save_battery(GB_gameboy_t *gb, const char *path);

GB_ADDIN_API void GB_load_battery_from_buffer(GB_gameboy_t *gb, const uint8_t *buffer, size_t size);
GB_ADDIN_API void GB_load_battery(GB_gameboy_t *gb, const char *path);

GB_ADDIN_API void GB_set_turbo_mode(GB_gameboy_t *gb, bool on, bool no_frame_skip);
GB_ADDIN_API void GB_set_rendering_disabled(GB_gameboy_t *gb, bool disabled);
    
GB_ADDIN_API void GB_log(GB_gameboy_t *gb, const char *fmt, ...) __printflike(2, 3);
GB_ADDIN_API void GB_attributed_log(GB_gameboy_t *gb, GB_log_attributes attributes, const char *fmt, ...) __printflike(3, 4);

GB_ADDIN_API void GB_set_pixels_output(GB_gameboy_t *gb, uint32_t *output);
GB_ADDIN_API void GB_set_border_mode(GB_gameboy_t *gb, GB_border_mode_t border_mode);
    
GB_ADDIN_API void GB_set_infrared_input(GB_gameboy_t *gb, bool state);
    
GB_ADDIN_API void GB_set_vblank_callback(GB_gameboy_t *gb, GB_vblank_callback_t callback);
GB_ADDIN_API void GB_set_log_callback(GB_gameboy_t *gb, GB_log_callback_t callback);
GB_ADDIN_API void GB_set_input_callback(GB_gameboy_t *gb, GB_input_callback_t callback);
GB_ADDIN_API void GB_set_async_input_callback(GB_gameboy_t *gb, GB_input_callback_t callback);
GB_ADDIN_API void GB_set_rgb_encode_callback(GB_gameboy_t *gb, GB_rgb_encode_callback_t callback);
GB_ADDIN_API void GB_set_infrared_callback(GB_gameboy_t *gb, GB_infrared_callback_t callback);
GB_ADDIN_API void GB_set_rumble_callback(GB_gameboy_t *gb, GB_rumble_callback_t callback);
GB_ADDIN_API void GB_set_update_input_hint_callback(GB_gameboy_t *gb, GB_update_input_hint_callback_t callback);
/* Called when a new boot ROM is needed. The callback should call GB_load_boot_rom or GB_load_boot_rom_from_buffer */
GB_ADDIN_API void GB_set_boot_rom_load_callback(GB_gameboy_t *gb, GB_boot_rom_load_callback_t callback);
    
GB_ADDIN_API void GB_set_palette(GB_gameboy_t *gb, const GB_palette_t *palette);

/* These APIs are used when using internal clock */
GB_ADDIN_API void GB_set_serial_transfer_bit_start_callback(GB_gameboy_t *gb, GB_serial_transfer_bit_start_callback_t callback);
GB_ADDIN_API void GB_set_serial_transfer_bit_end_callback(GB_gameboy_t *gb, GB_serial_transfer_bit_end_callback_t callback);

/* These APIs are used when using external clock */
GB_ADDIN_API bool GB_serial_get_data_bit(GB_gameboy_t *gb);
GB_ADDIN_API void GB_serial_set_data_bit(GB_gameboy_t *gb, bool data);
    
GB_ADDIN_API void GB_disconnect_serial(GB_gameboy_t *gb);
    
/* For cartridges with an alarm clock */
GB_ADDIN_API unsigned GB_time_to_alarm(GB_gameboy_t *gb); // 0 if no alarm
    
/* For integration with SFC/SNES emulators */
GB_ADDIN_API void GB_set_joyp_write_callback(GB_gameboy_t *gb, GB_joyp_write_callback_t callback);
GB_ADDIN_API void GB_set_icd_pixel_callback(GB_gameboy_t *gb, GB_icd_pixel_callback_t callback);
GB_ADDIN_API void GB_set_icd_hreset_callback(GB_gameboy_t *gb, GB_icd_hreset_callback_t callback);
GB_ADDIN_API void GB_set_icd_vreset_callback(GB_gameboy_t *gb, GB_icd_vreset_callback_t callback);
    
GB_ADDIN_API uint32_t GB_get_clock_rate(GB_gameboy_t *gb);
GB_ADDIN_API void GB_set_clock_multiplier(GB_gameboy_t *gb, double multiplier);

GB_ADDIN_API unsigned GB_get_screen_width(GB_gameboy_t *gb);
GB_ADDIN_API unsigned GB_get_screen_height(GB_gameboy_t *gb);
GB_ADDIN_API double GB_get_usual_frame_rate(GB_gameboy_t *gb);
GB_ADDIN_API unsigned GB_get_player_count(GB_gameboy_t *gb);
